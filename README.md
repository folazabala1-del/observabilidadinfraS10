## Alumno
Olazabal Avila Fernando

## Cambios respecto al repositorio original
- Corregida versión inexistente de Grafana (12.4.0 → 11.1.0)
- Adaptado node-exporter para Docker Desktop en Windows (eliminado pid: host y rslave)
- Corregida consulta PromQL de CPU por contenedor para Windows (id="/docker" en lugar de name="lab-backend")
